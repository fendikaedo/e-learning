                            ...
                            <tbody>
                                @foreach ($data_guru as $guru)
                                    <tr>
                                        ...
                                        <td class="border-bottom-0">
                                            <h6 class="fw-semibold mb-1">{{ $guru->nip }}</h6>
                                            <span class="fw-normal">{{ $guru->nama_guru }}</span>
                                        </td>
                                        <td class="border-bottom-0">
                                            <p class="mb-0 fw-normal">{{ $guru->jabatan->nama_jabatan }}</p>
                                        </td>
                                        <td class="border-bottom-0">
                                            <a class="btn btn-primary btn-sm mb-0 fw-normal" href="{{ route('data_guru.index') }}">View Data</a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
