                        ...
                        <table class="table table-striped text-nowrap mb-0 align-items-md-center text-center">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="border-bottom-0">
                                        <h6 class="fw-normal mb-1">78156189164</h6>
                                    </td>
                                    <td class="border-bottom-0">
                                        <p class="mb-0 fw-normal">Fendika Edo Ferdinata</p>
                                    </td>
                                    <td class="border-bottom-0">
                                        <span class="badge bg-primary rounded-3 fw-semibold">Pemrograman Web</span>
                                    </td>
                                    <td class="border-bottom-0">
                                ...
                                <tr>
                                    ...
                                    <td class="border-bottom-0">
                                        <p class="mb-0 fw-normal">Hermawan Juliyanto</p>
                                    </td>
                                    <td class="border-bottom-0">
                                        <span class="badge bg-danger rounded-3 fw-semibold">Jaringan NASA</span>
                                    </td>
                                    <td class="border-bottom-0">
                                        <h6 class="fw-normal mb-0">Laki Laki</h6>
                                    </td>
